  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Mongso ini tidak ada di kalender kami.</p>
        <Link
          to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Pranata Calculator — Kearifan Lokal, Divalidasi Sains" },
      {
        name: "description",
        content:
          "Validasi ilmiah kalender tani Pranata Mongso dengan data cuaca real-time untuk petani Indonesia.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d6fa0b81-138f-4d3b-9e73-3bc00d2dd819/id-preview-d8e563dc--1eae002c-de26-4265-b3b6-be02f72ac4b8.lovable.app-1777627047958.png",
      },
      {
        name: "twitter:image",
        content:
